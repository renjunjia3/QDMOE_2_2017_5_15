...
import com.cyldf.cyldfxv.bean.IndexInfo;
...
import com.cyldf.cyldfxv.ui.view.NewBanner;
import com.cyldf.cyldfxv.util.API;
import com.cyldf.cyldfxv.util.GlideImageLoader;
...
public class HotRecommendFragment extends BaseFragment {
    ...
    private void getIndexData(boolean isShowLoading) {
        if (NetWorkUtils.isNetworkConnected(_mActivity)) {
            ...
            OkHttpUtils.get().url(API.URL_PRE + API.HOT_RECOMMEND).build().execute(new StringCallback() {
                @Override
