package com.fxonok.fxonokzojb.ui.dialog;
...
import com.fxonok.fxonokzojb.pay.PayUtil;
 ...
 */
public class RapidDoubletVipDialog extends Dialog {
    public RapidDoubletVipDialog(@NonNull Context context) {
        super(context);
    }

    public RapidDoubletVipDialog(@NonNull Context context, @StyleRes int themeResId) {
        super(context, themeResId);
    }

    protected RapidDoubletVipDialog(@NonNull Context context, boolean cancelable, @Nullable OnCancelListener cancelListener) {
    ...
    public static class Builder {
        ...
        public RapidDoubletVipDialog create() {
            ...
            layout.findViewById(R.id.open_vip).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (type == 1) {
                        PayUtil.getInstance().payByWeChat(context, dialog, PayUtil.VIP_TYPE_9, videoId,isVideoDetailPage);
                    } else {
                        PayUtil.getInstance().payByAliPay(context, dialog, PayUtil.VIP_TYPE_9, videoId,isVideoDetailPage);
                    }
