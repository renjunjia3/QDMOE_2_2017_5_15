package com.cjhnsqjg.cjhnsq.ui.view;
...
public class NewBanner extends FrameLayout implements OnPageChangeListener {
    ...
    public NewBanner(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initView(Context context, AttributeSet attrs) {
        imageViews.clear();
        View view = LayoutInflater.from(context).inflate(R.layout.new_banner, this, true);
        viewPager = (ChildViewPager) view.findViewById(R.id.bannerViewPager);
    ...
    public NewBanner isAutoPlay(boolean isAutoPlay) {
        this.isAutoPlay = isAutoPlay;
        return this;
    }

    public NewBanner setImageLoader(ImageLoaderInterface imageLoader) {
        this.imageLoader = imageLoader;
        return this;
    }

    public NewBanner setDelayTime(int delayTime) {
        this.delayTime = delayTime;
        return this;
    }

    public NewBanner setIndicatorGravity(int type) {
        switch (type) {
    ...
    public NewBanner setBannerAnimation(Class<? extends PageTransformer> transformer) {
        try {
     ...
     * @return Banner
     */
    public NewBanner setOffscreenPageLimit(int limit) {
        if (viewPager != null) {
     ...
     * @return Banner
     */
    public NewBanner setPageTransformer(boolean reverseDrawingOrder, PageTransformer transformer) {
        viewPager.setPageTransformer(reverseDrawingOrder, transformer);
        return this;
    }

    public NewBanner setBannerTitles(List<String> titles) {
        this.titles = titles;
        return this;
    }

    public NewBanner setBannerStyle(int bannerStyle) {
        this.bannerStyle = bannerStyle;
        return this;
    }

    public NewBanner setViewPagerIsScroll(boolean isScroll) {
        this.isScroll = isScroll;
        return this;
    }

    public NewBanner setImages(List<?> imageUrls) {
...
//        Log.i(tag, ev.getAction() + "--" + isAutoPlay);
    ...
    @Deprecated
    public NewBanner setOnBannerClickListener(OnBannerClickListener listener) {
     ...
     * @return
     */
    public NewBanner setOnBannerListener(OnBannerListener listener) {
