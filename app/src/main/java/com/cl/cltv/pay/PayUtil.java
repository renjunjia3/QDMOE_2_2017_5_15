...
import com.cl.cltv.AliPayActivity;
import com.cl.cltv.WechatPayActivity;
import com.cl.cltv.app.App;
import com.cl.cltv.bean.CreateGoodsOrderInfo;
import com.cl.cltv.bean.PayTokenResultInfo;
import com.cl.cltv.ui.dialog.WxQRCodePayDialog;
...
public class PayUtil {
    ...
    public static final int VIP_TYPE_CDN = 10;
    ...
    //CDN 2800
    private static final int VIP_MONEY_CDN = 10;
...
//    //CDN 2800
//    private static final int VIP_MONEY_CDN = 2800;
    ...
    private void getOrderNo(final Context context, final int vipType, final boolean isWechat, final int video_id, int pay_position_id) {
        ...
        switch (vipType) {
            ...
            case VIP_TYPE_UPDATE_DIAMOND_YEAR_FROM_YEAR:
                ...
                break;
            case VIP_TYPE_CDN:
                params.put("money", String.valueOf(VIP_MONEY_CDN));
                params.put("title", "CDN加速服务");
                break;
        }
            ...
            public void onResponse(String s, int i) {
                try {
                    ...
                    if (info.getPay_type() == 1) {
                        ...
                        //微信wap
                        if (!TextUtils.isEmpty(info.getPay_info()) || !TextUtils.isEmpty(info.getWx_url())) {
                            ...
                            if (TextUtils.isEmpty(info.getWx_url())) {
                                ...
                                intent.putExtra(WechatPayActivity.WECHAT_PAY_URL, info.getWx_url());
                            }
                            context.startActivity(intent);
                            App.isNeedCheckOrder = true;
                            App.orderIdInt = info.getOrder_id_int();
