package com.plnrqrzy.tjtutfa.pull_loadmore;
...
import com.plnrqrzy.tjtutfa.pull_loadmore.indicator.PtrIndicator;
import com.plnrqrzy.tjtutfa.pull_loadmore.loadmore.DefaultLoadMoreFooter;
import com.plnrqrzy.tjtutfa.pull_loadmore.loadmore.GridViewHandler;
import com.plnrqrzy.tjtutfa.pull_loadmore.loadmore.ILoadViewMoreFactory;
import com.plnrqrzy.tjtutfa.pull_loadmore.loadmore.ILoadViewMoreFactory.ILoadMoreView;
import com.plnrqrzy.tjtutfa.pull_loadmore.loadmore.ListViewHandler;
import com.plnrqrzy.tjtutfa.pull_loadmore.loadmore.OnLoadMoreListener;
import com.plnrqrzy.tjtutfa.pull_loadmore.loadmore.OnScrollBottomListener;
import com.plnrqrzy.tjtutfa.pull_loadmore.loadmore.RecyclerViewHandler;
import com.plnrqrzy.tjtutfa.util.LogUtil;
...
public class PtrFrameLayout extends ViewGroup {
    ...
    public PtrFrameLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray arr = context.obtainStyledAttributes(attrs, com.plnrqrzy.tjtutfa.R.styleable.PtrFrameLayout, 0, 0);
        if (arr != null) {

            mHeaderId = arr.getResourceId(com.plnrqrzy.tjtutfa.R.styleable.PtrFrameLayout_ptr_header, mHeaderId);
            mContainerId = arr.getResourceId(com.plnrqrzy.tjtutfa.R.styleable.PtrFrameLayout_ptr_content, mContainerId);

            mPtrIndicator.setResistance(
                    arr.getFloat(com.plnrqrzy.tjtutfa.R.styleable.PtrFrameLayout_ptr_resistance, mPtrIndicator.getResistance()));

            mDurationToClose = arr.getInt(com.plnrqrzy.tjtutfa.R.styleable.PtrFrameLayout_ptr_duration_to_close, mDurationToClose);
            mDurationToCloseHeader = arr.getInt(com.plnrqrzy.tjtutfa.R.styleable.PtrFrameLayout_ptr_duration_to_close_header, mDurationToCloseHeader);

            float ratio = mPtrIndicator.getRatioOfHeaderToHeightRefresh();
            ratio = arr.getFloat(com.plnrqrzy.tjtutfa.R.styleable.PtrFrameLayout_ptr_ratio_of_header_height_to_refresh, ratio);
            mPtrIndicator.setRatioOfHeaderHeightToRefresh(ratio);

            mKeepHeaderWhenRefresh = arr.getBoolean(com.plnrqrzy.tjtutfa.R.styleable.PtrFrameLayout_ptr_keep_header_when_refresh, mKeepHeaderWhenRefresh);

            mPullToRefresh = arr.getBoolean(com.plnrqrzy.tjtutfa.R.styleable.PtrFrameLayout_ptr_pull_to_fresh, mPullToRefresh);
            arr.recycle();
        }
